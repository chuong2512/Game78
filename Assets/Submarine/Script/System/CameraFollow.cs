...
public class CameraFollow : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        targetPos.y = Mathf.Clamp(targetPos.y, _min.y + Camera.main.orthographicSize,
            _max.y - Camera.main.orthographicSize);

        transform.position = Vector3.Lerp(transform.position,
            new Vector3(targetPos.x, targetPos.y, transform.position.z), 1f / smooth);
    }
