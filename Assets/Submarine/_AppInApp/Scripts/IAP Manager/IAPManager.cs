...
public class IAPKey
{
    public const string PACK1 = "game78_1_submarine";
    public const string PACK2 = "game78_2_submarine";
    public const string PACK3 = "game78_3_submarine";
    public const string PACK4 = "game78_4_submarine";
    
    public const string PACK1_REGISTER = "game78_register_1_submarine";
    public const string PACK2_REGISTER = "game78_register_2_submarine";
    public const string PACK3_REGISTER = "game78_register_3_submarine";
    public const string PACK4_REGISTER = "game78_register_4_submarine";
